...
\begin{commandexplain}{basicfeetbend}{}
	This dimension holds a hardcoded value to be used as the rotation of the feet. Its default value is \the\basicfeetbend. The left foot uses the negative value. It may be removed in the future (or replaced by an option).
...
With this code, we define these six commands: \cmddef{pingu@leftfoot@select}, \cmddef{pingu@leftfoot@add}, \cmddef{@pingu@drawer@leftfoot@}, \cmddef{pingu@rightfoot@select}, \cmddef{pingu@rightfoot@add}, and \cmddef{@pingu@drawer@rightfoot@}.

Within the initialization of all penguin options, we use these keys. Furthermore, \keyref{feet} acts as a comfort option which operates on both selectors:
% \pgfqkeys{/pingu}{
