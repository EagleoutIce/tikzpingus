...
\newenvironment{keyexplain}[4][/pingu/]{\minipage{\linewidth}
	...
	\hspace*{-\keyexplainindent}\ifcsname pingu@@lib@#2@\endcsname\index{Library!\textit{\csname pingu@@lib@#2@\endcsname}!#2?\hyperref[pk:#1#2]{\protect\lpingu{#2}}}\llap{$\underset{\text{\tiny\smash{\raisebox{3pt}{\textsf{\hyperref[Libraries]{\color{gray}Library}}}}}}{\text{\textit{\footnotesize\strut\csname pingu@@lib@#2@\endcsname}}}$\quad~}\fi\colorbox{\explaincolor}{%
