...
\newsavebox\pinguboxB
\savebox\pinguboxB{\tikz\pingu[wings raise,head band,eyes angry,sunglasses,bow tie=pingu@purple,body type=chubby];}
\begin{center}
\begin{tikzpicture}
    \node[text width=13.5cm, inner sep=11pt] (m) {%
...
Copyright \textcopyright\ \texttt{Florian Sihler}. Permission is granted to copy, distribute and\slash or modify this software under the terms of the GNU General Public License, version 3.0 \url{https://opensource.org/licenses/gpl-3.0.html}.
