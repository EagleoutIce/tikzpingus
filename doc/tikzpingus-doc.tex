...
\newenvironment{keyexplain}[4][/pingu/]{\minipage{\linewidth}
	...
	}\ifcsname pingu@@lib@\@key @\endcsname\index[\current@indexfile]{Libraries!\textit{\csname pingu@@lib@#2@\endcsname}!\@idxkey?\hyperref[pk:#1\@key]{\protect\lpingu{#2}}}\rlap{~\quad\raisebox{2.75pt}{$\underset{\text{\tiny\smash{\raisebox{3pt}{\textsf{\hyperref[Libraries]{\color{gray}Library}}}}}}{\text{\textit{\footnotesize\parbox{4em}{\null\hfill\strut\csname pingu@@lib@#2@\endcsname\hfill\null}}}}$}}\fi\kern-\linewidth\par\endgroup
}
...
\subkeyexplain{witchhat}{witch hat position}{angle>:(<x>,<y>)<scale}{\pingu@x@witchhat@angle:(\pingu@x@witchhat@xshift,\pingu@x@witchhat@yshift)\{\pingu@x@witchhat@scale\}}
...
\begin{tcblisting}{@}
\begin{tikzpicture}
	\pingu[on horse,on horse flip=true]
\end{tikzpicture}
\end{tcblisting}
\endsubkeyexplain
...
\begin{tcblisting}{@}
\begin{tikzpicture}
	\pingu[on horse,on horse draw=green]
\end{tikzpicture}
\end{tcblisting}
\endsubkeyexplain
...
\begin{tcblisting}{@}
\begin{tikzpicture}
	\pingu[on horse,on horse mane=green]
\end{tikzpicture}
\end{tcblisting}
\endsubkeyexplain
...
\begin{tcblisting}{@}
\begin{tikzpicture}
	\pingu[on horse,on horse mane draw=green]
\end{tikzpicture}
\end{tcblisting}
\endsubkeyexplain
...
\begin{tcblisting}{@}
\begin{tikzpicture}
	\pingu[on horse,on horse thatch=green]
\end{tikzpicture}
\end{tcblisting}
\endsubkeyexplain
...
\begin{tcblisting}{@}
\begin{tikzpicture}
	\pingu[on horse,on horse thatch draw=green]
\end{tikzpicture}
\end{tcblisting}
\endsubkeyexplain
...
\begin{tcblisting}{@}
\begin{tikzpicture}
	\pingu[on horse,on horse tail=green]
\end{tikzpicture}
\end{tcblisting}
\endsubkeyexplain
...
\begin{tcblisting}{@}
\begin{tikzpicture}
	\pingu[on horse,on horse tail draw=green]
\end{tikzpicture}
\end{tcblisting}
\endsubkeyexplain
...
\begin{tcblisting}{@}
\begin{tikzpicture}
	\pingu[on horse,on horse eyes=green]
\end{tikzpicture}
\end{tcblisting}
\endsubkeyexplain
...
\begin{tcblisting}{@}
\begin{tikzpicture}
	\pingu[on horse,on horse mouth=green]
\end{tikzpicture}
\end{tcblisting}
\endsubkeyexplain
...
\begin{tcblisting}{@}
\begin{tikzpicture}
	\pingu[on horse,on horse nose=green]
\end{tikzpicture}
\end{tcblisting}
\endsubkeyexplain
...
\begin{tcblisting}{@}
\begin{tikzpicture}
	\pingu[on horse,on horse ears=green]
\end{tikzpicture}
\end{tcblisting}
\endsubkeyexplain
...
\begin{tcblisting}{@}
\begin{tikzpicture}
	\pingu[on horse,on horse xshift=1cm]
\end{tikzpicture}
\end{tcblisting}
\endsubkeyexplain
...
\begin{tcblisting}{@}
\begin{tikzpicture}
	\pingu[on horse,on horse yshift=1cm]
\end{tikzpicture}
\end{tcblisting}
\endsubkeyexplain
...
\begin{tcblisting}{@}
\begin{tikzpicture}
	\pingu[on horse,on horse scale=.25]
\end{tikzpicture}
\end{tcblisting}
\endsubkeyexplain
}
...
\end{tcblisting}
\endsubkeyexplain
\subkeyexplain{present left}{present left band}{color}{\pingu@color@presentleft@band}
\begin{tcblisting}{@}
\begin{tikzpicture}
...
\begin{tcblisting}{@}
\begin{tikzpicture}
	\pingu[present left, present left band second height=3mm]
\end{tikzpicture}
\end{tcblisting}
\endsubkeyexplain
...
\begin{tcblisting}{@}
\begin{tikzpicture}
	\pingu[present left, present left band second yshift=3mm]
\end{tikzpicture}
\end{tcblisting}
\endsubkeyexplain
...
\begin{tcblisting}{@}
\begin{tikzpicture}
	\pingu[present right, present right band second height=3mm]
\end{tikzpicture}
\end{tcblisting}
\endsubkeyexplain
...
\begin{tcblisting}{@}
\begin{tikzpicture}
	\pingu[present right, present right band second yshift=3mm]
\end{tikzpicture}
\end{tcblisting}
\endsubkeyexplain
...
\begin{tcblisting}{@}
\begin{tikzpicture}
	\pingu[present right, present right lid overhang=1mm]
\end{tikzpicture}
\end{tcblisting}
\endsubkeyexplain
...
\subkeyexplain{present right}{present right lid band}{color}{\pingu@color@presentright@lid@band}
\begin{tcblisting}{@}
\begin{tikzpicture}
