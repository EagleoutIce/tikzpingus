...
This code, defines three commands: \cmddef{pingu@bill@select}, \cmddef{pingu@bill@add}, \cmddef{@pingu@bill@lefteye@}.
...
\begin{commandexplain}{pingu@bill@s}{\mand{name}\mand{bill}}
	...
	\important\space Your code for the eyes \textit{must} create the coordinate \lpingu{\\pingu@name-bill-bottom}. This is not checked! It is recommended to use the coordinate \lpingu{\\pingu@name-bill} for reference.
\end{commandexplain}
...
\important\space Please note, that when writing the initial penguin, i did not intend to allow for additional body shapes. Therefore, most of the defaults and \say{globals} are must be defined here (alongside a lot of hardcoding).
