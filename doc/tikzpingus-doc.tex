...
\long\def\ParseDTLListElement#1"#2"\@nil{\textsuperscript{\smash{\ifcsname pingu@@lib@#2@\endcsname\index{Libraries!\textit{\csname pingu@@lib@#2@\endcsname}!#2?\hyperref[pk:/pingu/#2]{\protect\lpingu{#2}}}~$\underset{\text{\tiny\smash{\raisebox{3pt}{\textsf{\hyperref[Libraries]{\color{gray}Library}}}}}}{\text{\textit{\scriptsize\strut\csname pingu@@lib@#2@\endcsname}}}$\!\fi}}}
