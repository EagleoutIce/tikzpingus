...
With this, we define \cmddef{pingu@righteye@select}, \cmddef{pingu@righteye@add}, \cmddef{@pingu@drawer@righteye@}, \cmddef{pingu@lefteye@select}, \cmddef{pingu@lefteye@add}, and \cmddef{@pingu@drawer@lefteye@}.
...
Both eyes have two colors to work with: \cmdcoldef{eye@left}, \cmdcoldef{eye@second@left}, \cmdcoldef{eye@right}, and \cmdcoldef{eye@second@right}.
