...
\newenvironment{keyexplain}[4][/pingu/]{\minipage{\linewidth}
	...
	\hspace*{-\keyexplainindent}\ifcsname pingu@@lib@#2@\endcsname\llap{\textit{\footnotesize\csname pingu@@lib@#2@\endcsname~~}\index{\csname pingu@@lib@#2@\endcsname?\hyperref[pk:#1#2]{\protect\lpingu{#2}}}}\fi\colorbox{\explaincolor}{%
