...
\newenvironment{keyexplain}[4][/pingu/]{\minipage{\linewidth}
	...
	}\ifcsname pingu@@lib@#2@\endcsname\typeout{Got: #2}\index{Libraries!\textit{\csname pingu@@lib@#2@\endcsname}!#2?\hyperref[pk:#1#2]{\protect\lpingu{#2}}}\rlap{~\quad$\underset{\text{\tiny\smash{\raisebox{3pt}{\textsf{\hyperref[Libraries]{\color{gray}Library}}}}}}{\text{\textit{\footnotesize\strut\csname pingu@@lib@#2@\endcsname}}}$}\else\typeout{Miss: #2}\fi\par\endgroup
}
