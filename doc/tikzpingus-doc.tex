...
\begingroup
\def\explaincolor{@softexplaincolor}\def\keyexplainindent{0em}%
{\def\\{}\protected@xdef\@subidxkey{#2}}%% backslash should not interfere with keys
...
\begin{commandexplain}{pingu@<selection>@add}{\mand{select}}

\end{commandexplain}

\begin{commandexplain}{@pingu@drawer@<selection>@}{}
