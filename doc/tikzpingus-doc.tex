...
With this code, we define the six following commands: \cmddef{pingu@leftfoot@select}, \cmddef{pingu@leftfoot@add}, \cmddef{@pingu@drawer@leftfoot@}, \cmddef{pingu@rightfoot@select}, \cmddef{pingu@rightfoot@add}, and \cmddef{@pingu@drawer@rightfoot@}.
...
\cmddef{pingu@color@foot@left} for the left and \cmddef{pingu@color@foot@right} for the right foot.
...
\end{commandexplain}
The macro \cmdref{pingu@feet@s} is defined like this:
