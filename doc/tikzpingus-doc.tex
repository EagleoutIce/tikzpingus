...
\newenvironment{keyexplain}[4][/pingu/]{\minipage{\linewidth}
	...
	\hspace*{-\keyexplainindent}\ifcsname pingu@@lib@#2@\endcsname\index{Library!\csname pingu@@lib@#2@\endcsname!#2?\hyperref[pk:#1#2]{\protect\lpingu{#2}}}\llap{$\underset{\text{\tiny\textsf{Library}}}{\text{\textit{\footnotesize\csname pingu@@lib@#2@\endcsname\qquad~}}}$}\fi\colorbox{\explaincolor}{%
