...
While Section~\ref{Usage} \say{\nameref*{Usage}} explains some basics on how to use the library, Appendix~\autoref{Gadget-Overview} (\nameref{Gadget-Overview}) presents a overview of interesting gadgets, and \autoref{sec:full-ref} (\nameref{sec:full-ref}) acts as a reference of all keys.
