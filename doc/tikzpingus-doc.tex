...
At the moment, it loads \href{\TikZ}{https://www.ctan.org/pkg/pgf}, which loads a lot of other packages (e.g. |xcolor|), and \href{etoolbox}{https://www.ctan.org/pkg/etoolbox}.
