...
\def\cmdstyle{\@declaredcolor{doc-main}}
...
\def\@CreateCodeHyperLink#1#2#3#4{\lstset{add to literate={#2}{{\hyperref[#3]{#4}}}{#1}}}
...
\def\CreateCodeHyperLink#1#2{% \StrLen{\@elem}[\@cclen]
	...
	\edef\@tmp{\noexpand\@CreateCodeHyperLink{#2}{\@sub}{pk:/pingu/\@elem}{\hyperstyle\@subb}}\@tmp\fi}%
}
