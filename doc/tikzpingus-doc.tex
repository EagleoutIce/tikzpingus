...
\subkeyexplain{mitra}{mitra upper band width}{factor}{\pingu@x@mitra@upperband@width}
\begin{tcblisting}{@}
\begin{tikzpicture}
	\pingu[mitra,mitra upper band width=.5]
\end{tikzpicture}
\end{tcblisting}
\endsubkeyexplain
...
\subkeyexplain{mitra}{mitra center band height}{factor}{\pingu@x@mitra@centerband@height}
\begin{tcblisting}{@}
\begin{tikzpicture}
	\pingu[mitra,mitra center band height=.5]
\end{tikzpicture}
\end{tcblisting}
\endsubkeyexplain
}
