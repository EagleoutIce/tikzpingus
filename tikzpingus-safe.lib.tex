...
\pingu@draw[line width=.7pt]{\pingu@color@mask@band} ([yshift=.1mm,xshift=.2mm]@ll) to[bend left=1]  ([yshift=.25mm]\pingu@name-wing-right-start);
\pingu@draw[line width=.7pt]{\pingu@color@mask@band} ([yshift=.1mm,xshift=-.2mm]@lr) to[bend right=1] ([yshift=.25mm]\pingu@name-wing-left-start);
\endscope
