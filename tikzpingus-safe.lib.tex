...
}{mask band=\pingu@color@body@main, mask band inner=\pingu@color@mask@band!75!\pingu@color@mask, mask band outer=\pingu@color@mask@band!95!\pingu@color@mask,mask line width=.565pt}
...
\pingu@draw[line width=\pingu@x@mask@line@width]{\pingu@color@mask@band} ([yshift=-.1mm,xshift=.2mm]@ul) to[bend right=1] ([yshift=-1.1mm]\pingu@name-wings-side-right);
\pingu@draw[line width=\pingu@x@mask@line@width]{\pingu@color@mask@band} ([yshift=-.1mm,xshift=-.2mm]@ur) to[bend left=1]  ([yshift=-1.1mm]\pingu@name-wings-side-left);
\endscope\scope
\clip[use path=\pingu@lowerpingu];
\pingu@draw[line width=\pingu@x@mask@line@width]{\pingu@color@mask@band} ([yshift=.1mm,xshift=.2mm]@ll) to[bend left=1]  ([yshift=.15mm]\pingu@name-wing-right-start);
\pingu@draw[line width=\pingu@x@mask@line@width]{\pingu@color@mask@band} ([yshift=.1mm,xshift=-.2mm]@lr) to[bend right=1] ([yshift=.15mm]\pingu@name-wing-left-start);
\endscope
