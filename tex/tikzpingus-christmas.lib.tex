...
\path ([yshift=-\pingu@deerhat@yshift]\pingu@name-head-left) arc (\pingu@deerhat@baseang@l:\pingu@deerhat@baseang@l-\pingu@deerhat@baseoff:\pingu@w@half{} and \pingu@head@h@half) coordinate (@target);

\pingu@draw[line width=.65mm]{\pingu@color@deerhat@second} (@target) arc (\pingu@deerhat@baseang@l-\pingu@deerhat@baseoff:360+\pingu@deerhat@baseang@r+\pingu@deerhat@baseoff:\pingu@w@half{} and \pingu@head@h@half);

\pgfonlayer{background}
\pingu@draw[line width=1mm,rounded corners=4pt,line cap=round]{\pingu@color@deerhat} (\pingu@name-head-left) -- ++(.75mm,1.75mm) -- ++(6.25mm,1.5mm) -- ++(.5mm,1.75mm);
\pingu@draw[line width=1mm,rounded corners=4pt,line cap=round]{\pingu@color@deerhat} (\pingu@name-head-left) -- ++(.75mm,1.75mm) -- ++(6.25mm,1.5mm) -- ++(.5mm,1.75mm);
\pingu@draw[line width=1mm,rounded corners=4pt,line cap=round]{\pingu@color@deerhat} (\pingu@name-head-right) -- ++(-.75mm,1.75mm) -- ++(-6.25mm,1.5mm) -- ++(-.5mm,1.75mm);
\endpgfonlayer
}