...
% \csname pingu@color@magnifier#1\endcsname
    \pingu@block{\csname pingu@color@magnifier@#1@handle\endcsname}(\pingu@name-wing-#1)++(\@sidesign*-.2mm,\csname pingu@magnifier@#1@shift\endcsname+4mm)
    arc (250:-70:3mm) arc (-70:-250:.33mm) arc (-70:250:3mm-.66mm);
