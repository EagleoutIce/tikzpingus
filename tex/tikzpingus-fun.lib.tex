...
}{magnifier \@lr\space handle length=3.5mm, magnifier \@lr\space handle=pingu@bronze, magnifier \@lr\space handle shift=-4mm, magnifier \@lr\space width=7mm,magnifier \@lr\space height=3.5mm, magnifier \@lr\space xshift=0mm,magnifier \@lr\space yshift=1mm,magnifier \@lr\space size=2.5mm,magnifier \@lr\space thick=.5mm,magnifier \@lr\space glass=pingu@blue!90!pingu@yellow,magnifier \@lr\space opacity=0.24}
...
\pgfonlayer{foreground}
  \pingu@block[even odd rule]{\csname pingu@color@magnifier@#1@handle\endcsname} (@) circle[radius=\csname pingu@magnifier@#1@size\endcsname] circle[radius=\csname pingu@magnifier@#1@size\endcsname-\csname pingu@magnifier@#1@thick\endcsname];
    ...
    \pingu@block{\csname pingu@color@magnifier@#1@handle\endcsname}
