...
\pingu@create@wing@extra{broom}{%
    ...
    broom \@lr\space pad/.code          = \pingu@color{broom@\@lr @pad}{##1},
    ...
    broom \@lr\space bristles d/.code   = \pingu@color{broom@\@lr @bristles@d}{##1},
}{broom \@lr\space length=22mm,broom \@lr\space shift=8mm, broom \@lr\space pad=\csname pingu@color@broom\@lr\endcsname!99!pingu@black, broom \@lr\space bristles a=pingu@bronze!13!pingu@yellow!31!pingu@white!95!\csname pingu@color@broom\@lr\endcsname, broom \@lr\space bristles b=\csname pingu@color@broom@\@lr @bristles@a\endcsname!94!pingu@black, broom \@lr\space bristles c=\csname pingu@color@broom@\@lr @bristles@b\endcsname!94!pingu@black, broom \@lr\space bristles d=\csname pingu@color@broom@\@lr @bristles@c\endcsname!94!pingu@black}
...
\scope[rotate around={\@angle:(\pingu@name-wing-#1)}]
    ...
    % TODO: lighter
    \pingu@block{\csname pingu@color@broom@#1@bristles@a\endcsname} (\pingu@name-broom-#1-top)++(-2.75mm,0) to[out=115,in=240] ++(3mm,9.5mm) to[out=300,in=65] ([xshift=2.75mm]\pingu@name-broom-#1-top) -- cycle;
    \pingu@block{\csname pingu@color@broom@#1@bristles@b\endcsname} (\pingu@name-broom-#1-top)++(-2.5mm,0) to[out=115,in=240] ++(2.75mm,8.25mm) to[out=300,in=65] ([xshift=2.5mm]\pingu@name-broom-#1-top) -- cycle;
    \pingu@block{\csname pingu@color@broom@#1@bristles@c\endcsname} (\pingu@name-broom-#1-top)++(-2.25mm,0) to[out=115,in=240] ++(2.5mm,7.25mm) to[out=300,in=65] ([xshift=2.25mm]\pingu@name-broom-#1-top) -- cycle;
    \pingu@block{\csname pingu@color@broom@#1@bristles@d\endcsname} (\pingu@name-broom-#1-top)++(-.5mm,0) to[out=105,in=260] ++(.75mm,5.75mm) to[out=280,in=65] ([xshift=.3mm]\pingu@name-broom-#1-top) -- cycle;
    % TODO: broom cap color etc
    \pingu@block{\csname pingu@color@broom@#1@pad\endcsname}(\pingu@name-broom-#1-top) ellipse[x radius=3mm,y radius=.533mm];
\endscope
}