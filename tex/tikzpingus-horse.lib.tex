...
\pingu@block[draw=\csname pingu@color@horse#1@fl@hoof\endcsname!80!pingu@black,line width=2pt*\pingu@@horse@scale]{\csname pingu@color@horse#1@fl@hoof\endcsname} (@hooffront) to[bend left=2] ++(.355*.65,-.545*.5) to[bend left=15] ++(-.45,-.1) to[bend left=10] ++(-.293,.105) to[bend left=9] ++(.04,.25) to[bend right=15] cycle;
