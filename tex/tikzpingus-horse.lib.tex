...
\pingu@block[draw=\csname pingu@color@horse#1@base@shade@draw\endcsname,line width=2pt*\pingu@@horse@scale,rounded corners=.12]{\csname pingu@color@horse#1@base@shade\endcsname} (@hooffront@) to[bend left=2] ++(0,-.565*.665) to[bend left=59] ++(-.225,-.08) -- ++(-.02,.03) to[bend left=20] ++(-.298,.11) to[bend right=6] ++(.092,.3) to[bend right=15] cycle;
% background back le0
