...
\makeindex[title=Command Overview,columns=2,columnsep=.75cm,noautomatic=true]
...
\lstdefinestyle{lstpingu}{%
	...
	emphstyle=\slshape,
	emphstyle=[2]\color{pingu@blue!75!black}\slshape,
...
\newenvironment{keyexplain}[4][/pingu/]{\begin{minipage}{\linewidth}%
	...
	\def\@tmp{#4}%
	\hspace*{-2em}\colorbox{gray!10!white}{%
