...
\newcommand\ShowcasePengu[2][]{{\hypersetup{linkcolor=.}\hyperref[pk:/pingu/#2]{\tabular{c}\scalebox{.75}{\tikzpicture
	\pingu[body=pingu@main!30!white,bill color=pingu@yellow!30!white,feet color=pingu@yellow!30!white,eyes color=pingu@black!30!white,#2#1]
\endtikzpicture}\\[-1mm]\textsf{\strut #2}\endtabular}}}
\def\pengu@all@showcases{}
\def\ShowcaseThis#1{\appto\pengu@all@showcases{{#1},}}
...
\@for\@elem:=\pengu@all@showcases\do{%
	\ifx\@elem\@empty\else
	% space to space cmd
	\edef\@tmp{\noexpand\ShowcasePengu\@elem}\@tmp
\fi}%
\global\let\pengu@all@showcases\@empty
}
...
\colorlet{@softexplaincolor}{gray!10!white}
