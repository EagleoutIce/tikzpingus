...
\RedeclareSectionCommand[afterskip=-2mm]{section}
...
\keyalias{headband bend}{head band bend}
\keyalias{head-band bend}{head band bend}
...
\keyalias{headband angle}{head band angle}
\keyalias{head-band angle}{head band angle}
...
\keyalias{headband upper angle}{head band upper angle}
\keyalias{head-band upper angle}{head band upper angle}
...
\keyalias{headband knot}{head band knot}
\keyalias{head-band knot}{head band knot}
...
\keyalias{headband knot color}{head band knot color}
\keyalias{head-band knot color}{head band knot color}}
...
\keyalias{headband knot a color}{head band knot a color}
\keyalias{head-band knot a color}{head band knot a color}}
...
\begin{tikzpicture}
	\pingu[head band, head band knot,
		head band knot a color=orange,
		head band knot b color=green]
\end{tikzpicture}
\end{tcblisting}
\end{subkeyexplain}

\keyalias{headband knot b color}{head band knot b color}
\keyalias{head-band knot b color}{head band knot b color}}
...
\keyalias{headband bands}{head band bands}
\keyalias{head-band bands}{head band bands}
...
\keyalias{headband bands a color}{head band bands a color}
\keyalias{head-band bands a color}{head band bands a color}}
...
\begin{tikzpicture}
	\pingu[head band, head band bands,
		head band bands a color=orange,
		head band bands b color=green]
\end{tikzpicture}
\end{tcblisting}
\end{subkeyexplain}

\keyalias{headband bands b color}{head band bands b color}
\keyalias{head-band bands b color}{head band bands b color}}
