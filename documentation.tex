...
\lstdefinelanguage{pingulang}{
	...
	moreemph=[2]{left,right,wing,eye,wings,tie,bow,none,eyes,shiny,wink,wave,grab,hug,wave,cup,straw,xshift,yshift,meta,dots,name,heart,shock,bill,hair,hairstyle,feet,foot,simple,flat,angry,back,devil,normal,princess,crown,silver,medal,patch,halo,glow,thick,2d,sunglasses,gem,shade,round,lollipop,lightsaber,item,angle,raise,cane,flip,flag,sign,post,cloak,scale,meta-dots,color,body,head,main,front,second,small,size,large,style,hairs,1,2,3,4,5,knot,length,offset,width,pattern,bowtie,bow-tie,a,b,c,text,gold,bronze,band,eyepatch,eye-patch,monocle,glass,opacity,string,blob,pants,button,buttons,bands,no,without,extra,steps,function,solid,right,frame,eye-frame,eyeframe,glasses,fill,line,sun,horns,devilhorns,devil-horns,headband,head-band,bend, upper,rook,hatch,strawhat,hat,ribbon,position,base,coronal,3d,colors,ring,bobbles,bobble,cake-hat,candle,fire,wick,outline,top,handle,hand,cast,handcast,signpost,font,fontcolor,deco,ribbs,double,core,outer,disabled,factor,german,code,pole,pride,staff,cape,bottom,padding,pumpkin-hat,stalk,stripe,cap,type,vr-headset,headphone,vertical,above,santa,beard,blush,inner,headphones,shirt,banner,stick,sticks,bent,vr-controller,fork,mask},
...
% #1 Keys
\def\CreateCodeHyperLink#1{%
	\@for\@elem:=#1\do{\StrLen{\@elem}[\@cclen]\edef\@tmp{\noexpand\@CreateCodeHyperLink{\@cclen}{\@elem}{pk:/pingu/\@elem}}\@tmp}%
}
\CreateCodeHyperLink{height}
...
\lstMakeShortInline[style=lstpingu,language=pingulang,basicstyle=\relsize{-1}\ttfamily\color{black!90!white}]{|}
...
\begin{keyexplain}{body type}{body type}{default}
	Change the active body type:
\begin{tcblisting}{}
\begin{tikzpicture}
...
Set the length of the left monocle string:
\begin{tcblisting}{}
\begin{tikzpicture}
	\pingu[monocle left,
...
\begin{keyexplain}{cap}{color}{pingu@bronze}
Enable the cap with a specific color:
\begin{tcblisting}{}
\begin{tikzpicture}
	\pingu[cap=green]
\end{tikzpicture}
...
\begin{keyexplain}{pumpkin-hat}{color}{pingu@bronze!97!white}
...
Change the stalks color of the pumpkin hat:
\begin{tcblisting}{}
\begin{tikzpicture}
...
Change the stalks top color of the pumpkin hat:
\begin{tcblisting}{}
\begin{tikzpicture}
...
Exchange the outline color of the pumpkin hat:
\begin{tcblisting}{}
\begin{tikzpicture}
...
Exchange the outline width of the pumpkin hat:
\begin{tcblisting}{}
\begin{tikzpicture}
...
\begin{keyexplain}{vr-headset}{color}{pingu@black!92!gray}
Enable a vr headset hat with a specific color:
\begin{tcblisting}{}
\begin{tikzpicture}
...
Change the color of the horizontal headset band:
\begin{tcblisting}{}
\begin{tikzpicture}
...
Change the color of the vertical headset band:
\begin{tcblisting}{}
\begin{tikzpicture}
...
Change the text on the headset:
\begin{tcblisting}{}
\begin{tikzpicture}
...
Change the text color of the headset text:
\begin{tcblisting}{}
\begin{tikzpicture}
...
\begin{keyexplain}{headphone}{color}{pingu@blue!80!pingu@black}
Enable a headphones hat with a specific color:
\begin{tcblisting}{}
\begin{tikzpicture}
...
Change the color of the right headphone:
\begin{tcblisting}{}
\begin{tikzpicture}
...
Change the color of the left outer headphone padding:
\begin{tcblisting}{}
\begin{tikzpicture}
...
Change the color of the right outer headphone padding:
\begin{tcblisting}{}
\begin{tikzpicture}
...
Change the color of the left inner headphone padding:
\begin{tcblisting}{}
\begin{tikzpicture}
...
Change the color of the right inner headphone padding:
\begin{tcblisting}{}
\begin{tikzpicture}
...
\begin{keyexplain}{santa hat}{color}{pingu@red!87!pingu@black}
...
Change the wool color of the bobble:
\begin{tcblisting}{}
\begin{tikzpicture}
...
\begin{keyexplain}{santa beard}{color}{pingu@white!96!pingu@red!98!pingu@black!92!gray}
Show the merry christmas beard:
\begin{tcblisting}{}
\begin{tikzpicture}
...
\begin{keyexplain}{blush}{color}{pingu@red}
Make it cute:
\begin{tcblisting}{}
\begin{tikzpicture}
...
\begin{keyexplain}{banner}{text}{Bannertext}
...
Changes the banners main color:
\begin{tcblisting}{}
\begin{tikzpicture}
...
Changes the banners text color:
\begin{tcblisting}{}
\begin{tikzpicture}
...
Changes the banners left stick color:
\begin{tcblisting}{}
\begin{tikzpicture}
...
Changes the banners right stick color:
\begin{tcblisting}{}
\begin{tikzpicture}
...
\begin{subkeyexplain}{lightsaber left}{lightsaber left length}{length}{\pingu@x@lightsaber@length@left}
	Change the length of the penguins lightsaber:
\begin{tcblisting}{}
\begin{tikzpicture}
...
\begin{keyexplain}{flag left}{color}{pingu@purple}
	Give the penguin a small flag:
\begin{tcblisting}{}
\begin{tikzpicture}
...
\begin{keyexplain}{pride flag left}{color}{pingu@bronze}
...
\begin{keyexplain}{german flag left}{color}{pingu@bronze}
...
\begin{keyexplain}{flag right}{color}{pingu@purple}
	Give the penguin a small flag:
\begin{tcblisting}{}
\begin{tikzpicture}
...
\begin{keyexplain}{pride flag right}{color}{pingu@bronze}
...
\begin{keyexplain}{german flag right}{color}{pingu@bronze}
...
\begin{keyexplain}{staff left}{color}{pingu@bronze}
	Give the penguin a staff:
\begin{tcblisting}{}
\begin{tikzpicture}
...
\begin{keyexplain}{staff right}{color}{pingu@bronze}
	Give the penguin a staff:
\begin{tcblisting}{}
\begin{tikzpicture}
...
\begin{keyexplain}{cloak}{color}{pingu@bronze}
	Display a cloak in a given color:
\begin{tcblisting}{}
\begin{tikzpicture}
	\pingu[cloak=green]
\end{tikzpicture}
...
\begin{subkeyexplain}{cloak}{cloak padding}{length}{\pingu@x@cloak@padding}
	Change the cloaks padding parameter:
\begin{tcblisting}{}
\begin{tikzpicture}
...
\begin{keyexplain}{cape}{color}{pingu@bronze}
...
\begin{keyexplain}{shirt}{color}{pingu@bronze}
	Display a shirt in a given color:
\begin{tcblisting}{}
\begin{tikzpicture}
	\pingu[shirt=green]
\end{tikzpicture}
...
\begin{keyexplain}{second shirt}{color}{pingu@red}
