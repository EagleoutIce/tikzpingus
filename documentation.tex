...
\def\RawShowcase#1#2{\clap{\tabular{c}\scalebox{.75}{\begin{tcbexternal}{showcase-#2#1}%
\tikzpicture[baseline={(current bounding box.south)}]
...
\endtikzpicture
\end{tcbexternal}%
}\\[-1mm]\textsf{\strut\smash{#2}}\endtabular}

\setox0=\hbox{\RawShowcase{}{}}
\newdimen\pingu@showcase@height
\pingu@showcase@height=\dimexpr\ht0+\dp0\relax

\newcommand\ShowcasePengu[2][]{{\hypersetup{linkcolor=.}%
\hyperref[pk:/pingu/#2]{\parbox[b][\pingu@showcase@height]{.2\linewidth}{\centering\RawShowcase{#1}{#2}}}}}}
...
\tcbset{external/prefix=sub_,external/input source on error=true,shield externalize=true}
...
\begin{document}
\setox0=\hbox{\maketitle}\box0 % kill page break?
...
\showkeyexplain{heart}{node-options}{}
\begin{tcblisting}{@}
\begin{tikzpicture}
	\pingu[heart=green]
\end{tikzpicture}
...
\showkeyexplain{glow}{color}{pingu@white}
...
\showkeyexplain{blush}{color}{pingu@red}
Make it cute:
\begin{tcblisting}{@}
\begin{tikzpicture}
