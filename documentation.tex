...
\def\@CreateCodeHyperLink#1#2#3{\typeout{#2[#1] => #3}\lstset{add to literate={#2}{{\hyperref[#3]{\optstyle#2}}}{#1}}}
% #1 Keys
\def\CreateCodeHyperLink#1{%
	\@for\@elem:=#1\do{\StrLen{\@elem}[\@cclen]\ifnum\@cclen>0\edef\@tmp{\noexpand\@CreateCodeHyperLink{\@cclen}{\@elem}{pk:/pingu/\@elem}}\@tmp\fi}%
}
\providecommand\allcmds{XXXXDUMMY}% TODO: remove <void>
\AtBeginDocument{\expandafter\CreateCodeHyperLink\expandafter{\allcmds}\let\allcmds\@empty} % last to stop infinite
\AtEndDocument{\immediate\write\@auxout{\noexpand\gdef\noexpand\allcmds{\allcmds}}}
