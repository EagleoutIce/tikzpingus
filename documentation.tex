...
\subsubsection{Adding a new eyes}
The macro \lpingu{\\@pingu@eyes@s{<name>}{<left>}{<right>}} allows for the addition of new eye styles.
The \say{normal} eyes could be defined as follows:
\begin{lstlisting}[style=lstpingu,language=pingulang]
\@pingu@eyes@s{normal}{%
