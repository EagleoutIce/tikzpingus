...
\@whilenum\count@<\@cntmax@\do{
	...
	\ifcsname allcmds@\i\endcsname
		\edef\allcmds{\csname allcmds@\i\endcsname}% if undefined => emptyy
...
\keyexplain{body type}{body type}{default}
...
\begin{subkeyexplain}{monocle left}{monocle left string length}{length}{\pingu@x@monocleleft@string@l}
\begin{tcblisting}{}
\begin{tikzpicture}
	\pingu[monocle left,
...
\begin{subkeyexplain}{monocle right}{monocle right string length}{length}{\pingu@x@monocleright@string@r}
...
\begin{subkeyexplain}{halo}{halo above}{true/false}{\if@pingu@x@halo@above true\else false\fi}
...
\begin{subkeyexplain}{cap padding}{cap padding}{length}{\pingu@x@cap@padding}
\begin{tcblisting}{}
\begin{tikzpicture}
...
\begin{subkeyexplain}{cap extra height}{cap extra height}{length}{\pingu@x@cap@height}
\begin{tcblisting}{}
\begin{tikzpicture}
...
\begin{subkeyexplain}{pumpkin-hat}{pumpkin-hat stalk}{color}{\pingu@color@pumpkinhat@stalk}
\begin{tcblisting}{}
\begin{tikzpicture}
...
{\begin{subkeyexplain}{pumpkin-hat}{pumpkin-hat stalk top}{color}{<pumpkinhat-stalk-color>!95!pingu@black}
\begin{tcblisting}{}
\begin{tikzpicture}
...
\begin{subkeyexplain}{pumpkin-hat}{pumpkin-hat stripe a}{color}{\pingu@color@pumpkinhat@stripe@a}
...
\begin{subkeyexplain}{pumpkin-hat}{pumpkin-hat stripe b}{color}{\pingu@color@pumpkinhat@stripe@b}
...
\begin{subkeyexplain}{pumpkin-hat}{pumpkin-hat stripe c}{color}{\pingu@color@pumpkinhat@stripe@c}
...
\begin{subkeyexplain}{pumpkin-hat}{pumpkin-hat outline}{color}{\pingu@color@pumpkinhat@outline}
\begin{tcblisting}{}
\begin{tikzpicture}
...
\begin{subkeyexplain}{pumpkin-hat}{pumpkin-hat outline width}{color}{\pingu@x@pumpkinhat@outline@w}
\begin{tcblisting}{}
\begin{tikzpicture}
...
\begin{subkeyexplain}{pumpkin-hat}{pumpkin-hat position}{angle>:(<x>,<y>)<scale}{\pingu@x@pumpkinhat@angle:(\pingu@x@pumpkinhat@xshift,\pingu@x@pumpkinhat@yshift)\{\pingu@x@pumpkinhat@scale\}}
...
\begin{subkeyexplain}{vr-headset}{vr-headset band}{color}{\pingu@color@vrheadset@band}
\begin{tcblisting}{}
\begin{tikzpicture}
...
{\def\pingu@color@vrheadset{<vr-headset>}
\begin{subkeyexplain}{vr-headset}{vr-headset band top}{color}{\pingu@color@vrheadset@band@top}
\begin{tcblisting}{}
\begin{tikzpicture}
...
\begin{subkeyexplain}{vr-headset}{vr-headset hair}{}{}
...
\begin{subkeyexplain}{vr-headset}{vr-headset text}{text}{omitted}
\begin{tcblisting}{}
\begin{tikzpicture}
...
\begin{subkeyexplain}{vr-headset}{vr-headset text color}{color}{\pingu@color@vrheadset@text@color}
\begin{tcblisting}{}
\begin{tikzpicture}
...
\begin{subkeyexplain}{headphone}{headphone left}{color}{\pingu@color@headphone@left}
...
{\def\pingu@color@headphone{<headphone>}
\begin{subkeyexplain}{headphone}{headphone right}{color}{\pingu@color@headphone@right}
\begin{tcblisting}{}
\begin{tikzpicture}
...
\begin{subkeyexplain}{headphone}{headphone left outer}{color}{pingu@black}
\begin{tcblisting}{}
\begin{tikzpicture}
...
\begin{subkeyexplain}{headphone}{headphone right outer}{color}{pingu@black}
\begin{tcblisting}{}
\begin{tikzpicture}
...
\begin{subkeyexplain}{headphone}{headphone outer}{color}{pingu@black}
...
\begin{subkeyexplain}{headphone}{headphone left inner}{color}{pingu@black}
\begin{tcblisting}{}
\begin{tikzpicture}
...
\begin{subkeyexplain}{headphone}{headphone right inner}{color}{pingu@black}
\begin{tcblisting}{}
\begin{tikzpicture}
...
\begin{subkeyexplain}{headphone}{headphone inner}{color}{pingu@black}
...
\begin{subkeyexplain}{santa hat}{santa hat second}{color}{\pingu@color@santahat@second}
...
{
\begin{subkeyexplain}{santa hat}{santa hat bobble}{color}{<santa hat second>}
\begin{tcblisting}{}
\begin{tikzpicture}
...
\begin{subkeyexplain}{santa beard}{santa beard second}{color}{\pingu@color@santabeard@string}
\begin{tcblisting}{}
\begin{tikzpicture}
...
\begin{subkeyexplain}{blush}{blush second}{color}{<blush>}
\begin{tcblisting}{}
\begin{tikzpicture}
...
\begin{subkeyexplain}{blush}{blush opacity}{factor}{\pingu@x@blush@opacity}
\begin{tcblisting}{}
\begin{tikzpicture}
...
\begin{subkeyexplain}{banner}{banner band}{color}{\pingu@color@banner@band}
\begin{tcblisting}{}
\begin{tikzpicture}
...
\begin{subkeyexplain}{banner}{banner text color}{color}{\pingu@color@banner@text@color}
\begin{tcblisting}{}
\begin{tikzpicture}
...
\begin{subkeyexplain}{banner}{banner stick left color}{color}{\pingu@color@banner@stick@left}
\begin{tcblisting}{}
\begin{tikzpicture}
...
\begin{subkeyexplain}{banner}{banner stick right color}{color}{\pingu@color@banner@stick@right}
\begin{tcblisting}{}
\begin{tikzpicture}
...
\begin{subkeyexplain}{banner}{banner sticks color}{color}{\pingu@color@banner@stick@left}
...
\begin{subkeyexplain}{banner}{banner stick left length}{length}{\pingu@banner@stick@left@l}
...
\begin{subkeyexplain}{banner}{banner stick right length}{length}{\pingu@banner@stick@right@l}
...
\begin{subkeyexplain}{banner}{banner sticks length}{color}{\pingu@banner@stick@left@l}
...
\begin{subkeyexplain}{banner}{banner raise}{length}{\pingu@banner@raise}
...
\begin{subkeyexplain}{banner}{banner height}{length}{\pingu@banner@height}
...
\begin{subkeyexplain}{banner}{banner font}{font}{<fat font>}
...
\begin{subkeyexplain}{banner}{banner bent}{angle}{\pingu@banner@bent}
...
\begin{subkeyexplain}{cane left}{cane left raise}{length}{\pinug@x@cane@raise@left}
...
\begin{subkeyexplain}{cane right}{cane right raise}{length}{\pinug@x@cane@raise@right}
	Raise the cane of the pingu:
\begin{tcblisting}{}
\begin{tikzpicture}
...
\begin{subkeyexplain}{lightsaber left}{lightsaber left button}{color}{\pingu@color@lightsaberleft@button}
...
\begin{subkeyexplain}{lightsaber left}{lightsaber left button b}{color}{\pingu@color@lightsaberleft@button@b}
...
\begin{subkeyexplain}{lightsaber left}{lightsaber left double}{true/false}{\if@pingu@x@lightsaber@double@left true\else false\fi}
...
\begin{subkeyexplain}{lightsaber left}{lightsaber left color b}{color}{\pingu@color@lightsaberleft@color@b}
...
\begin{subkeyexplain}{lightsaber left}{lightsaber left length}{length}{\pingu@x@lightsaber@length@left}
\begin{tcblisting}{}
\begin{tikzpicture}
...
\begin{subkeyexplain}{lightsaber left}{lightsaber left length b}{length}{\pingu@x@lightsaber@length@b@left}
...
\begin{subkeyexplain}{lightsaber left}{lightsaber left yshift}{length}{\pingu@x@lightsaber@yshift@left}
...
\begin{subkeyexplain}{lightsaber left}{lightsaber left glow}{true/false}{\if@pingu@x@lightsaber@glow@left true\else false\fi}
...
\begin{subkeyexplain}{lightsaber left}{lightsaber left solid}{}{}
...
\begin{subkeyexplain}{lightsaber left}{lightsaber left glow core}{color}{\pingu@color@lightsaberleft@glow@core}
...
\begin{subkeyexplain}{lightsaber left}{lightsaber left outer glow factor}{factor}{\pingu@x@lightsaber@ogf@left}
...
\begin{subkeyexplain}{lightsaber left}{lightsaber left disabled}{}{}
...
\begin{subkeyexplain}{lightsaber right}{lightsaber right button}{color}{\pingu@color@lightsaberright@button}
	Change the color of the penguins lightsabers' first button:
\begin{tcblisting}{}
\begin{tikzpicture}
	\pingu[lightsaber right,
...
\begin{subkeyexplain}{lightsaber right}{lightsaber right button b}{color}{\pingu@color@lightsaberright@button@b}
	Change the color of the penguins lightsabers' second button:
\begin{tcblisting}{}
\begin{tikzpicture}
	\pingu[lightsaber right,
...
\begin{subkeyexplain}{lightsaber right}{lightsaber right double}{true/false}{\if@pingu@x@lightsaber@double@right true\else false\fi}
Toggle the visibility of the second lightsaber:
\begin{tcblisting}{}
\begin{tikzpicture}
...
{\def\@col{<lightsaber-color>}
\begin{subkeyexplain}{lightsaber right}{lightsaber right color b}{color}{\pingu@color@lightsaberright@color@b}
...
\begin{subkeyexplain}{lightsaber right}{lightsaber right length}{length}{\pingu@x@lightsaber@length@right}
\begin{tcblisting}{}
\begin{tikzpicture}
	\pingu[lightsaber right,
...
\begin{subkeyexplain}{lightsaber right}{lightsaber right length b}{length}{\pingu@x@lightsaber@length@b@right}
...
\begin{subkeyexplain}{lightsaber right}{lightsaber right yshift}{length}{\pingu@x@lightsaber@yshift@right}
	Shift the penguins lightsaber in the y direction:
\begin{tcblisting}{}
\begin{tikzpicture}
	\pingu[lightsaber right,
...
\begin{subkeyexplain}{lightsaber right}{lightsaber right glow}{true/false}{\if@pingu@x@lightsaber@glow@right true\else false\fi}
Toggle the glow of the lightsaber. The default is controlled by the \texttt{glows}-package option.
\begin{tcblisting}{}
\begin{tikzpicture}
	\pingu[lightsaber right,
...
\begin{subkeyexplain}{lightsaber right}{lightsaber right solid}{}{}
...
\begin{subkeyexplain}{lightsaber right}{lightsaber right glow core}{color}{\pingu@color@lightsaberright@glow@core}
Change the color of the lightsabers glow core:
\begin{tcblisting}{}
\begin{tikzpicture}
...
\begin{subkeyexplain}{lightsaber right}{lightsaber right outer glow factor}{factor}{\pingu@x@lightsaber@ogf@right}
...
\begin{subkeyexplain}{lightsaber right}{lightsaber right disabled}{}{}
Disables the lightsaber so only the handle is visible:
\begin{tcblisting}{}
\begin{tikzpicture}
...
\begin{subkeyexplain}{flag left}{flag left pole}{color}{\pingu@color@flagleft@pole}
...
\begin{subkeyexplain}{flag left}{flag left bobble}{color}{\pingu@color@flagleft@bobble}
...
\begin{subkeyexplain}{flag left}{flag left code}{\LaTeX-code}{omitted}
...
\begin{subkeyexplain}{flag right}{flag right pole}{color}{\pingu@color@flagright@pole}
Change the color of the flag pole:
	\begin{tcblisting}{}
\begin{tikzpicture}
...
\begin{subkeyexplain}{flag right}{flag right bobble}{color}{\pingu@color@flagright@bobble}
Change the color of the flag poles top bobble:
	\begin{tcblisting}{}
\begin{tikzpicture}
...
\begin{subkeyexplain}{flag right}{flag right code}{\LaTeX-code}{omitted}
Set the flag code which is effectively the drawing code of the flag.
You can use the styles \lpingu{/pingu/@flag@first} and \lpingu{/pingu/@flag} to inherit the default flag styles and to stay compliant with the modifications of the other macros:
	\begin{tcblisting}{}
\begin{tikzpicture}
...
\begin{subkeyexplain}{staff left}{staff left length}{length}{\pingu@staff@left@length}
...
\begin{subkeyexplain}{staff right}{staff right length}{length}{\pingu@staff@right@length}
Change the staff length:
\begin{tcblisting}{}
\begin{tikzpicture}
...
\begin{subkeyexplain}{cloak}{cloak cap}{color}{\pingu@color@cloak@cap}
\begin{tcblisting}{}
\begin{tikzpicture}
...
{\def\pingu@color@cloak{<cloak-color>}
\begin{subkeyexplain}{cloak}{cloak wings color}{color}{\pingu@color@cloak@wings}
\begin{tcblisting}{}
\begin{tikzpicture}
...
{\def\pingu@color@cloak{<cloak-color>}
\begin{subkeyexplain}{cloak}{cloak bottom color}{color}{\pingu@color@cloak@bottom}
...
{\def\pingu@color@cloak{<cloak-color>}
\begin{subkeyexplain}{cloak}{cloak front color}{color}{\pingu@color@cloak@front}
...
\begin{subkeyexplain}{cloak}{cloak padding}{length}{\pingu@x@cloak@padding}
\begin{tcblisting}{}
\begin{tikzpicture}
...
\begin{subkeyexplain}{shirt}{shirt raise}{length}{\pingu@shirt@raise}
\begin{tcblisting}{}
\begin{tikzpicture}
...
\begin{subkeyexplain}{shirt}{shirt padding}{length}{\pingu@shirt@padding}
\begin{tcblisting}{}
\begin{tikzpicture}
...
\begin{subkeyexplain}{shirt}{shirt button top}{color}{\pingu@color@shirt@button@top}
\begin{tcblisting}{}
\begin{tikzpicture}
...
\begin{subkeyexplain}{shirt}{shirt button middle}{color}{\pingu@color@shirt@button@middle}
\begin{tcblisting}{}
\begin{tikzpicture}
...
\begin{subkeyexplain}{shirt}{shirt button bottom}{color}{\pingu@color@shirt@button@bottom}
\begin{tcblisting}{}
\begin{tikzpicture}
...
\begin{subkeyexplain}{shirt}{shirt buttons}{color}{}
...
\begin{subkeyexplain}{shirt}{shirt button top shade}{color}{\pingu@color@shirt@button@top@shade}
\begin{tcblisting}{}
\begin{tikzpicture}
...
\begin{subkeyexplain}{shirt}{shirt button middle shade}{color}{\pingu@color@shirt@button@middle@shade}
\begin{tcblisting}{}
\begin{tikzpicture}
...
{\def\pingu@color@shirt@button@top{<shirt-button-top>}\def\pingu@color@shirt{<shirt-color>}
\begin{subkeyexplain}{shirt}{shirt button bottom shade}{color}{\pingu@color@shirt@button@bottom@shade}
\begin{tcblisting}{}
\begin{tikzpicture}
...
\begin{subkeyexplain}{shirt}{shirt buttons shade}{color}{}
...
\begin{subkeyexplain}{shirt}{shirt no buttons}{}{}
...
\begin{subkeyexplain}{shirt}{shirt above}{}{}
...
\begin{subkeyexplain}{second shirt}{second shirt raise}{length}{\pingu@secondshirt@raise}
\begin{tcblisting}{}
\begin{tikzpicture}
...
\begin{subkeyexplain}{second shirt}{second shirt neck}{color}{\pingu@color@secondshirt@neck}
\begin{tcblisting}{}
\begin{tikzpicture}
