...
\begin{subkeyexplain}{lightsaber left}{lightsaber left handle}{color}{\pingu@color@lightsaberleft@handle}
	Change the color of the penguins lightsaber
\begin{tcblisting}{}
\begin{tikzpicture}
