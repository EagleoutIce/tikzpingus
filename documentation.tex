...
\makeindex[title=Befehlsübersicht,columns=2,columnsep=.75cm,noautomatic=true]
...
\newenvironment{keyexplain}[4][/pingu/]{%
	...
	\hspace*{-2em}\colorbox{gray!10!white}{%
		\parbox{\dimexpr\linewidth-2\fboxsep+2em}{%
			\lpingu{#1#2 =\ }\texttt{<\textit{#3}>}\hfill
				\textcolor{gray}{(}\pgfkeys{/pingu/.cd,defaults}#4\textcolor{gray}{)}%
		}
	}\smallskip\\*}
{\bigskip\par}
...
\begin{keyexplain}{body main}{color}{\pingu@color@body@main}
	Set the main color of the penguin.%
\begin{tcblisting}{}
\begin{tikzpicture}
