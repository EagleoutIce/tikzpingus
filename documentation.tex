...
\def\RawShowcase#1#2{\scalebox{.71}{%\begin{tcbexternal}{showcase-#2#1}%
...
\node[below] at(current bounding box.south) {\clap{\textsf{\strut\smash{#1}}}};
\endtikzpicture
%\end{tcbexternal}%
}}
...
\newcommand\ShowcaseThis[2][]{\gappto\pengu@all@showcases{{#2=#1},}}
...
\showkeyexplain{glow}{color}{pingu@white}(orange)
