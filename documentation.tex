...
\subkeyexplain{conical hat}{conical hat rounding}{length}{\pingu@x@conical@rounding}
\begin{tcblisting}{}
\begin{tikzpicture}
	\pingu[conical hat,
...
\subkeyexplain{conical hat}{conical hat shade}{length}{\pingu@x@conical@shade}
\begin{tcblisting}{}
\begin{tikzpicture}
...
\subkeyexplain{conical hat}{conical hat padding}{length}{\pingu@x@conical@padding}
\begin{tcblisting}{}
\begin{tikzpicture}
	\pingu[conical hat,
	       conical hat padding=4mm]
\end{tikzpicture}
\end{tcblisting}
\endsubkeyexplain
...
\begin{tcblisting}{}
\begin{tikzpicture}
	\pingu[conical hat, conical hat height=6mm]
\end{tikzpicture}
\end{tcblisting}
\endsubkeyexplain
...
\subkeyexplain{conical hat}{conical hat position}{angle>:(<x>,<y>)<scale}{\pingu@x@conical@angle:(\pingu@x@conical@xshift,\pingu@x@conical@yshift)\{\pingu@x@conical@scale\}}
