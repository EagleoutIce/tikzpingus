...
\keyexplain{light-staff left length}{length}{\pingu@lightstaff@left@length}
\begin{tcblisting}{}
\begin{tikzpicture}
...
\keyexplain{light-staff left glow length}{length}{\pingu@lightstaff@left@glow@length}
\begin{tcblisting}{}
\begin{tikzpicture}
	\pingu[light-staff left,
...
\keyexplain{light-staff left head}{color}{pingu@green}
...
\keyexplain{light-staff left staff}{color}{\pingu@color@lightstaff@left@staff}
\begin{tcblisting}{}
\begin{tikzpicture}
	\pingu[light-staff left,
...
\keyexplain{light-staff left core}{color}{\pingu@color@lightstaff@left@head@core}
\begin{tcblisting}{}
\begin{tikzpicture}
	\pingu[light-staff left,
...
\keyexplain{light-staff left core width}{length}{\pingu@lightstaff@left@core@width}
\begin{tcblisting}{}
\begin{tikzpicture}
	\pingu[light-staff left,
...
\keyexplain{light-staff left outer glow factor}{factor}{\pingu@x@lightstaff@ogf@left}
